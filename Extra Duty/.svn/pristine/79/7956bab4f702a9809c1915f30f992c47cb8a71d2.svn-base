...
//               Date date2 = df.parse("21/08/2013");
    ...
    public void setOrgId() {
        ...
        if (LineVo.getEstimatedRowCount() > 0) {
            ...
            //ViewObject linevo1 = ADFUtils.findIterator("DutyAllowanceLinesVoIterator").getViewObject();
          ViewObject linevo1 =
                ADFUtils.getApplicationModuleForDataControl("Oando_AMDataControl").findViewObject("DutyAllowanceLinesVo");
           
            //linevo1.getViewObject();
            Row r1 = linevo1.first();
            Row newRow1 = linevo1.createRow();
            newRow1.setAttribute("Trans_AllowanceType", "");
            newRow1.setAttribute("StartDate","");
            newRow1.setAttribute("EndDate", "");
            newRow1.setAttribute("AllowanceDays", "");
            newRow1.setAttribute("AllowanceRate", "");
            newRow1.setAttribute("AllowanceAmount", "");
            newRow1.setAttribute("Comments", "");
            linevo1.insertRow(newRow1);
